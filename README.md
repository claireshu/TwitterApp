...
* [x] Created actionbar icons with Sketch
* [x] Displays favorites and retweets counts
* [x] Tags, hashtags, and links are highlighted in blue text
* [x] Search query sent when user presses enter 
