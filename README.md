...
In the `src/TwitterApp.models`, create the models that represent the key data to be parsed and persisted within your application.
...
Open `src/TwitterApp/LoginActivity.java` and configure the `onLoginSuccess` method
